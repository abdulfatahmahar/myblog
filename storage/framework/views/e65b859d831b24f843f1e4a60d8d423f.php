...
<?php $__env->startSection('index-page'); ?>
        <!-- start blog Section -->
        <section>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12 sm-margin-50px-bottom">
                        ...
                        <div class="row portfolio">
                            ...
                            <div class="col-md-6">
                                <div class="grid">
                                    <div class="grid-img">
                                        <img src="<?php echo e(url('style/img/blog/travel-1.jpg')); ?>" alt="...">
                                    </div>

                                    <div class="grid-details">

                        <span class="category"><a href="<?php echo e(route('standard_post')); ?>">Family</a></span>

                                        <h5><a href="<?php echo e(route('standard_post')); ?>">Cute family in beach</a></h5>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur fugit.</p>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('standard_post')); ?>" class="btn-blog">Read More</a>
                                        </div>

                                        <div class="meta">
                                            <span class="date">26 Mar 2024</span>
                                            <span class="author">By <a href="<?php echo e(route('standard_post')); ?>">Luis Shaw</a></span>
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="grid">
                                    <div class="grid-img">
                                        <img src="<?php echo e(url('style/img/blog/travel-3.jpg')); ?>" alt="...">
                                    </div>

                                    <div class="grid-details">

                                        <span class="category"><a href="<?php echo e(route('standard_post')); ?>">Adventure</a></span>
                            ...
                            <div class="col-md-6">
                                <div class="grid">
                                    <div class="grid-img">
                                        <img src="<?php echo e(url('style/img/blog/travel-4.jpg')); ?>" alt="...">
                                    </div>

                                    <div class="grid-details">

                                        <span class="category"><a href="<?php echo e(route('standard_post')); ?>">Solo</a></span>

                                        <h5><a href="<?php echo e(route('standard_post')); ?>">Start with travelling</a></h5>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur fugit.</p>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('standard_post')); ?>" class="btn-blog">Read More</a>
                                        </div>
                                        ...
                                        <div class="meta">
                                            ...
                                            <span class="author">By <a href="<?php echo e(route('standard_post')); ?>">Sophia Chaisson</a></span>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="grid">
                                    <div class="grid-img">
                                        <img src="<?php echo e(url('style/img/blog/travel-8.jpg')); ?>" alt="...">
                                    </div>

                                    <div class="grid-details">

                                        <span class="category"><a href="<?php echo e(route('standard_post')); ?>">Luxury</a></span>

                                        <h5><a href="<?php echo e(route('standard_post')); ?>">Boat view on lake</a></h5>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur fugit.</p>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('standard_post')); ?>" class="btn-blog">Read More</a>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="grid">
                                    <div class="grid-img">
                                        <img src="<?php echo e(url('style/img/blog/travel-7.jpg')); ?>" alt="...">
                                    </div>
                                    ...
                                    <div class="grid-details">
                                        ...
                                        <h5><a href="<?php echo e(route('standard_post')); ?>">Best mountain view</a></h5>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur fugit.</p>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('standard_post')); ?>" class="btn-blog">Read More</a>
                                        </div>
                                        ...
                                        <div class="meta">
                                            ...
                                            <span class="author">By <a href="<?php echo e(route('standard_post')); ?>">Sidney Gasser</a></span>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="grid">
                                    <div class="grid-img">
                                        <img src="<?php echo e(url('style/img/blog/travel-9.jpg')); ?>" alt="...">
                                    </div>
                                    ...
                                    <div class="grid-details">
                                        ...
                                        <h5><a href="<?php echo e(route('standard_post')); ?>">Snowman winter</a></h5>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur fugit.</p>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('standard_post')); ?>" class="btn-blog">Read More</a>
                                        </div>
                                        ...
                                        <div class="meta">
                                            ...
                                            <span class="author">By <a href="<?php echo e(route('standard_post')); ?>">Edward Simon</a></span>
                                        </div>
                        ...
                        <div class="side-bar padding-30px-left md-no-padding-left">
                            ...
                            <div class="widget padding-30px-all md-padding-20px-all shadow-theme">
                                <div class="widget-title margin-35px-bottom">
                                    ...
                                    <img src="<?php echo e(url('style/img/blog/blog-7.jpg')); ?>" class="mr-4" alt="" />
                                ...
                                <div class="media margin-20px-bottom">
                                    <img src="<?php echo e(url('style/img/blog/blog-8.jpg')); ?>" class="mr-4" alt="" />
                                    <div class="media-body">
                            ...
                            <div class="widget">
                                <div class="bg-img text-center padding-30px-all cover-background" data-overlay-dark="5" data-background="<?php echo e(url('style/img/content/testimonial.jpg')); ?>">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myblog\resources\views/index.blade.php ENDPATH**/ ?>