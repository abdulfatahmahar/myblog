...
<?php $__env->startSection('single-portfolio-page'); ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12 sm-margin-50px-bottom">
                        <div>
                            <img src="<?php echo e(url('style/img/portfolio/portfolio1.jpg')); ?>" class="margin-30px-bottom" alt="...">
                            ...
                            <div class="row margin-30px-bottom">
                                <div class="col-md-4 xs-margin-20px-bottom">
                                    <img src="<?php echo e(url('style/img/portfolio/portfolio2.jpg')); ?>" alt="..." />
                                </div>
                                <div class="col-md-4">
                                    <img src="<?php echo e(url('style/img/portfolio/portfolio3.jpg')); ?>" alt="..." />
                                </div>
                                <div class="col-md-4 xs-display-none">
                                    <img src="<?php echo e(url('style/img/portfolio/portfolio4.jpg')); ?>" alt="..." />
                                </div>
                            </div>
                        ...
                        <div class="side-bar padding-30px-left md-no-padding-left">
                            ...
                            <div class="widget padding-30px-all md-padding-20px-all shadow-theme">
                                ...
                                <div class="media margin-20px-bottom">
                                    <img src="<?php echo e(url('style/img/blog/blog-6.jpg')); ?>" class="mr-4" alt="" />
                                ...
                                <div class="media">
                                    <img src="<?php echo e(url('style/img/blog/blog-5.jpg')); ?>" class="mr-4" alt="" />
                                    <div class="media-body">
                            ...
                            <div class="widget padding-30px-all md-padding-20px-all shadow-theme">
                                ...
                                <ul class="insta-link text-center no-margin-bottom">
                                    <li>
                                        <a href="#"><img src="<?php echo e(url('style/img/blog/insta-1.jpg')); ?>" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(url('style/img/blog/insta-2.jpg')); ?>" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(url('style/img/blog/insta-3.jpg')); ?>" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(url('style/img/blog/insta-4.jpg')); ?>" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(url('style/img/blog/insta-5.jpg')); ?>" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(url('style/img/blog/insta-6.jpg')); ?>" alt=""></a>
                                    </li>
                                </ul>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myblog\resources\views/single-portfolio.blade.php ENDPATH**/ ?>