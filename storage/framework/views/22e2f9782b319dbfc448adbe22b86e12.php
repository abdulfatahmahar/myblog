                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 sm-margin-40px-bottom">
                            <img src="<?php echo e(url('style/img/logos/logo.png')); ?>" class="width-70" alt="" />
                        </div>
                    ...
                    <div class="padding-30px-bottom margin-60px-top row">
                        <div class="col-12">
                            ...
                            <div class="float-right xs-width-100 text-center">
                                <p class="text-medium-gray margin-5px-top xs-no-margin-top">&copy; 2024
                                Live is Powered by Abdul Fatah</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- start scroll to top -->
    <a href="<?php echo e(url('style/javascript:void(0)')); ?>" class="scroll-to-top"><i class="fas fa-angle-up" aria-hidden="true"></i></a>
    <!-- end scroll to top -->

    <!-- all js include start -->

    <!-- JavaScript -->
    <script src="<?php echo e(url('style/js/core.min.js')); ?>"></script>
	
	<!-- Search -->
    <script src="<?php echo e(url('style/search/search.js')); ?>"></script>
	
    <!-- custom scripts -->
    <script src="<?php echo e(url('style/js/main.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\myblog\resources\views/layout/footer.blade.php ENDPATH**/ ?>