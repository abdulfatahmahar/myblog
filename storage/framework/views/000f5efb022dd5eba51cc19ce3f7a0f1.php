...
<?php $__env->startSection('about-page'); ?>
                    ...
                    <div class="col-lg-8 col-md-12 sm-margin-50px-bottom">
                        <div>
                            <div class="margin-30px-bottom">
                                <img src="<?php echo e(url('style/img/content/about.jpg')); ?>" alt="" />
                            </div>
                            ...
                            <div class="widget padding-30px-all md-padding-20px-all shadow-theme">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="font-size14">12 Jan, 2024</span>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myblog\resources\views/about.blade.php ENDPATH**/ ?>