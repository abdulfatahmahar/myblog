            ...
            <div class="container">
                ...
                <div class="row form-row gallery-post">
                    ...
                    <div class="col-md-4">
                        <div class="grid">
                            <div class="grid-img">
                                <img src="{{ url('style/img/blog/gallery-blog1.jpg')}}" alt="...">
                            </div>
                            <div class="gallery-text">
                                <a href="{{ url('style/img/blog/gallery-blog1.jpg')}}" class="popimg">Magnifying Glass</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="grid">
                            <div class="grid-img">
                                <img src="{{ url('style/img/blog/gallery-blog2.jpg')}}" alt="...">
                            </div>
                            <div class="gallery-text">
                                <a href="{{ url('style/img/blog/gallery-blog2.jpg')}}" class="popimg">Blog Description</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="grid">
                            <div class="grid-img">
                                <img src="{{ url('style/img/blog/gallery-blog3.jpg')}}" alt="...">
                            </div>
                            <div class="gallery-text">
                                <a href="{{ url('style/img/blog/gallery-blog3.jpg')}}" class="popimg">Magic Keyboard</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="grid">
                            <div class="grid-img">
                                <img src="{{ url('style/img/blog/gallery-blog4.jpg')}}" alt="...">
                            </div>
                            <div class="gallery-text">
                                <a href="{{ url('style/img/blog/gallery-blog4.jpg')}}" class="popimg">Computer Mouse</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="grid">
                            <div class="grid-img">
                                <img src="{{ url('style/img/blog/gallery-blog5.jpg')}}" alt="...">
                            </div>
                            <div class="gallery-text">
                    ...
                    <div class="col-md-4">
                        <div class="grid">
                            <div class="grid-img">
                                <img src="{{ url('style/img/blog/gallery-blog6.jpg')}}" alt="...">
                            </div>
                            <div class="gallery-text">
                                <a href="{{ url('style/img/blog/gallery-blog6.jpg')}}" class="popimg">Airplanes</a>
                            </div>
                        </div>
                    </div>
